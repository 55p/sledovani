...
$zacatekPlatnosti3 = '6.5.2016';
$zacatekPlatnosti4 = '20.5.2016';
$zacatekPlatnosti5 = '5.9.2016';
...
@$ts141 -> obeh (new Obeh($obeh, $trasa, $omezeni, $typ, $poznamkaObehu, $zacatekPlatnosti3, $konecPlatnosti)); 
@$ts141 -> obeh (new Obeh($obeh, $trasa, $omezeni, $typ, $poznamkaObehu, $zacatekPlatnosti4, $konecPlatnosti)); 
@$ts141 -> obeh (new Obeh($obeh, $trasa, $omezeni, $typ, $poznamkaObehu, $zacatekPlatnosti5, $konecPlatnosti)); 
